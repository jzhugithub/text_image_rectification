...
#define targetHeight 3264//处理图像的高度//修改
...
int main( )
{
	...
	Size outputSize = Size(origImage_o.cols*targetHeight/origImage_o.rows,targetHeight);
	resize(origImage_o, origImage_o, outputSize);
